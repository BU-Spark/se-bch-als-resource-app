...
const QuestionaireBodyContent: React.FC<Props> = () => {
  ...
  const initialChoices = [
    { id: '140', title: 'Communication', link: '/communication' },
    { id: '141', title: 'Computer Access', link: '/computer-access' },
    { id: '142', title: 'Home Access', link: '/home-access' },
    { id: '143', title: 'Smart Phone Access', link: '/smart-phone-access' },
  ];
